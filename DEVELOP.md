...
### Or add @eeacms/volto-eea-website-policy to your Volto project
...
1.  Add the following to `mrs.developer.json`:

        {
            "volto-eea-website-policy": {
                "output": "packages",
                "url": "https://github.com/eea/volto-eea-website-policy.git",
                "package": "@eeacms/volto-eea-website-policy",
                "branch": "develop",
                "path": "src"
            }
        }

1.  Add `@eeacms/volto-eea-website-policy` to the `addons` key in your project `volto.config.js`
...
1.  Happy hacking!
        ...
        cd packages/volto-eea-website-policy
...
project where you added `volto-eea-website-policy` to `mrs.developer.json`
...
This will build and start with Docker a clean `Plone backend` and `Volto Frontend` with `volto-eea-website-policy` block installed.
